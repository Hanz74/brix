...
class TestE2ERestApi:
    ...
    def _patch_localhost(self, monkeypatch):
        """Simulate localhost for all tests in this class (no API key configured)."""
        import brix.api as api_mod
        monkeypatch.setattr(api_mod, "_is_localhost", lambda _req: True)
