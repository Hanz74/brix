...
Status: 2026-04-09  
Scope: Einstiegspunkt zur kanonischen Vollversion des Brix-Architekturdossiers.

Die unverdichtete Vollversion liegt im Dossier-Paket:

- [00-master-dossier.md](/root/docker/brix/docs/brix-master-dossier/00-master-dossier.md)
...
Ergänzende Vorarbeiten:

- [brix-anti-workaround-strategy.md](/root/docker/brix/docs/brix-anti-workaround-strategy.md)
- [validator-masterplan.md](/root/docker/brix/docs/validator-masterplan.md)
- [brix-drift-remediation-plan.md](/root/docker/brix/docs/brix-drift-remediation-plan.md)
